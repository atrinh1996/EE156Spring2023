...
\doheading{2}{title}{Lab 1}
    ...
    \subsection{Miss Rate Decreased as Associativity Increased}
    \begin{figure}[htb!]
        \begin{adjustwidth}{-2.75cm}{}\begin{tabular}{ccc}
            \begin{subfigure}{0.42\textwidth}
                \centering
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \label{appendix:aggregate}
        ...
        \begin{figure}[htb!]
            ...
            \caption{L3 cache associativity and replacement policy graphed against miss rate for all three benchmarks. }
            \label{fig:all:Miss}
        \end{figure}
