...
\doheading{2}{title}{Lab 2 (*used 1 late token)}
    ...
    \subsection{cholesky} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %     \centering
        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/cholesky-0.PNG}
        %     % \caption{}
        %     \end{subfigure}%

        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/cholesky-4.PNG}
        %     % \caption{}
        %     \end{subfigure}%
        % \end{figure}
        % \clearpage
        ...
        %     \centering
        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/cholesky-8.PNG}
        %     % \caption{}
        %     \end{subfigure}%

        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/cholesky-16.PNG}
        %     % \caption{}
        %     \end{subfigure}%
    ...
    \subsection{fmm} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %     \centering
        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/fmm-0.PNG}
        %     % \caption{}
        %     \end{subfigure}%

        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/fmm-4.PNG}
        %     % \caption{}
        %     \end{subfigure}%
        % \end{figure}
        % \clearpage
        ...
        %     \centering
        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/fmm-8.PNG}
        %     % \caption{}
        %     \end{subfigure}%

        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/fmm-16.PNG}
        %     % \caption{}
        %     \end{subfigure}%
    ...
    \subsection{lu.cont} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %     \centering
        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/lu.cont-0.PNG}
        %     % \caption{}
        %     \end{subfigure}%

        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/lu.cont-4.PNG}
        %     % \caption{}
        %     \end{subfigure}%
        % \end{figure}
        % \clearpage
        ...
        %     \centering
        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/lu.cont-8.PNG}
        %     % \caption{}
        %     \end{subfigure}%

        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/lu.cont-16.PNG}
        %     % \caption{}
        %     \end{subfigure}%
    ...
    \subsection{radiosity} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %     \centering
        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/radiosity-0.PNG}
        %     % \caption{}
        %     \end{subfigure}%

        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/radiosity-4.PNG}
        %     % \caption{}
        %     \end{subfigure}%
        % \end{figure}
        % \clearpage
        ...
        %     \centering
        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/radiosity-8.PNG}
        %     % \caption{}
        %     \end{subfigure}%

        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/radiosity-16.PNG}
        %     % \caption{}
        %     \end{subfigure}%
    ...
    \subsection{raytrace} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        %     \centering
        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/raytrace-0.PNG}
        %     % \caption{}
        %     \end{subfigure}%

        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/raytrace-4.PNG}
        %     % \caption{}
        %     \end{subfigure}%
        % \end{figure}
        % \clearpage
        ...
        %     \centering
        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/raytrace-8.PNG}
        %     % \caption{}
        %     \end{subfigure}%

        %     \noindent\begin{subfigure}{0.8\textwidth}
        %     \includegraphics[width=1\textwidth]{images/CPI/raytrace-16.PNG}
        %     % \caption{}
        %     \end{subfigure}%
